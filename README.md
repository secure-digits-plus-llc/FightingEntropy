...
# Some elements of PSD-Master ... 
The full Johanstrom version is not yet fully integrated, but the tool does allow for a legacy MDT installation or an upgraded PSD installation. I am working on a way to have both features work together irrespective of the share environment or conditions. Cause, math is cool like that. I am making updates to the entire tool so that it is cohesive... it's pretty difficult to balance it all considering I'm a single guy. So.
...
I mean there are two types of people in the world, there are the negative Nancy's, and the positive Pam's. Granted, you could make the case that there are some sideways Sara's or maybe some halfway harry's... I guess either way you look at it? The challenge is being able to make the most out of the experience. And somehow enjoying what it feels like to kick myself in the nuts over and over and finding some silver lining where I can say I learned something AKA, that's my job now. It has it's moments where I have to go outside several times a day because this is not an easy task by any means. In fact, it is sort of a maximum amount of stress added to an exponential supply of problems that ... you really have to go outside and do a cold boot every once in a while. I'm not sure how I found a rhythm in all of this.. but I did, so... it's cool.

That said? Making some things happen with some pretty cool awesome stuff? Well, it's probably too cool for me to even be able to use these aforementioned terms in a sentence... which is some legit top notch badasseryhood. It's not a real word, but it could be.
