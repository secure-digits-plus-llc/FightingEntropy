...
\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯    ¯¯¯¯    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\___    ____ -- ____ __ ____ -- ____ __ ____ -- ____ __ ___// 
 ¯¯¯¯   [ Declare Namespaces & Load Modules ] __________________________________________//¯¯\\__//¯¯\\==//¯¯\----/¯¯\\==//¯¯\----/¯¯\\==//¯¯\----/¯¯¯  
        ...
        Convert-XAMLToWindow , Show-WPFWindow , Get-XAML , Find-XAMLNamedElements , Get-NetworkInfo , Start-PingSweep , Get-NBTSCAN , 
        Get-NetworkHosts , Get-TelemetryData , Resolve-MacAddress , Start-NetworkInfo , Get-NetworkStatistics , Initialize-PortScan , 
        Invoke-Login , Add-ACL , New-ACLObject , Import-MDTModule , Export-Ini , Resolve-UninstallList , Install-DSCRoot , Install-HybridDSC , 
        Initialize-HybridIIS , Initialize-HybridDSC , Unlock-Script , Resolve-LocalMachine , Update-HybridDSC , Update-Branding , 
        Export-BridgeScript , Get-DSCFeatureList , Confirm-DomainName , Get-DSCPromoTable , Get-DSCPromoSelection , Initialize-DomainController , 
        Initialize-Server , Get-CurrentServices , Sync-DNSSuffix , Register-PDCTimeSource , Resolve-Windows , Get-DiskInfo
